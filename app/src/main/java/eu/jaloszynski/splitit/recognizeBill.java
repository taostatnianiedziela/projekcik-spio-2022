...
import eu.jaloszynski.splitit.databinding.ActivityRecognizeBillBinding;

public class recognizeBill extends AppCompatActivity {

    private AppBarConfiguration appBarConfiguration;
    private ActivityRecognizeBillBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityRecognizeBillBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());



    //    NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_recognize_bill);
